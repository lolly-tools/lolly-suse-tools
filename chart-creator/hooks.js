...
// Categorical fallback palette — SUSE colours only, validated CVD-safe in both
// modes (see PALETTE & GUARD DESIGN). Rows with no explicit colour take a slot in
// order (BRAND[i % len]); the legibility guard below then keeps each visible on
// whatever surface it renders against.
const BRAND = ['#008657','#2453ff','#fe7c3f','#5d4f99','#00bda7','#bd3314','#3c8eef','#30ba78'];
...
// so a rescued mark is just a lighter/darker step of the same SUSE family.
